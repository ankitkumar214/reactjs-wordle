...
export default observer(function Display({ number }) {
  ...
  const handleKeyPress = (key) => {
    switch (number) {
      case 5:
        score.handleKeyup5({ key: key });
        break;
      case 6:
        score.handleKeyup6({ key: key });
        break;
      case 7:
        score.handleKeyup7({ key: key });
        break;
      default:
        break;
    }
    ...
    case 5:
      return (
        <>
          ...
          <Qwerty score={score} number={number} onKeyPress={handleKeyPress} />
          {showModal ? (
            <>
                ...
                <div className="relative w-auto my-6 mx-auto max-w-sm">
                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <div className="relative px-4 flex-auto">
                      <p className="my-4 text-black text-xl text-center leading-relaxed whitespace-pre-wrap">
                        {score.won5
                          ? "You Won 🎉\nPoints Scored: " +
                            score.scoreVal +
                            "\nCorrect Word: " +
              ...
              <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                <div className="relative w-auto my-6 mx-auto max-w-sm">
                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <div className="relative px-4 flex-auto">
                      <p className="my-4 text-black text-lg text-center leading-relaxed whitespace-pre-wrap">
                        {score.won6
                          ? "You Won 🎉\nPoints Scored: " +
                            score.scoreVal +
                            "\nCorrect Word: " +
